...
{% include base_path %}
{% capture fig_img %}
![BBC EPL Top Scorers]({{ base_path }}/img/blog/2019/web-scraping-r-rvest/bbc-epl-top-scorers.png)
{% endcapture %}
...
{% capture fig_img %}
![Inspect element]({{ base_path }}/img/blog/2019/web-scraping-r-rvest/inspect-element.png)
{% endcapture %}
